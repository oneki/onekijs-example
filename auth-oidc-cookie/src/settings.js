export default {
  idp: {
    google: {
      ...
      logoutEndpoint: 'https://localhost:3000/api/oauth2/logout',                 // a redirect is done to this relative URL, a absolute URL or a function returning a URL ((idp, context) => 'https://example.com/oauth2/logout?.....'). If it's a relative URL, it's prefixed by the server.baseUrl . Example: https://auth.oneki.net/logout
